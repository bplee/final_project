...
###################################
#
# Script to run an sbatch of fastqc
#
#
###################################
...
echo "Running fastqc of all filepaths in ${ACC_NUM_FILEPATH}"
...
sbatch --array=1-$job_array_size /athena/angsd/scratch/bplee/project/final_project/scripts/fastqc_analysis.sbatch
